...
<div class="devicesList page">
  <el-row :gutter="20">
    <el-col :span="18">
      <div class="box ">
        <div class="title">
          <span>{{query}}设备列表</span>
          <a v-if="!openClose.toString()==''||!status.toString()==''||!search.toString()==''" @click="set_clear"><i class="fa fa-times" aria-hidden="true"></i> 清空条件</a>
        </div>
        <div class="content">
          <div class="inhaul">
            <div class="left">
...
export default {
  ...
  methods: {
    ...
    get_data_query: function() {
      this.query = this.$route.query.group;
    },
    socketOn: function() {
      let that = this;
    ...
    get_propertyNum: function() {
      let num = 0;
      for (let i in this.devicesList) {
        num = num + this.devicesList[i].properties;
      }
      this.propertyN = num;
    },
    //data事件 结束 -------------------------
